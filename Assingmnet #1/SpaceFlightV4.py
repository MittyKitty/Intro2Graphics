...
#Date Last Modified: May 23, 2012
#Program Description: A simple text based game
#Revision History: Version 4.0 Cleaned text and fixed grammar mistakes to make easier to read
#                 Added loops to determin if what the user entered is valid
...
def chooseDestination():
        destination = ''
#Each function has a simluar loop, detects if the player enters a valid command
        while destination != '1' and destination != '2':
                ...
                print("Do you head to the asteroid belt? Where there are plently of")
                print("large rocks to mine but")
...
def detour():
        detourDecision = ''
        print("")
        print("A month into your return trip, you have several commanders come to you")
        ...
        while detourDecision != '1' and detourDecision != '2':
                ...
                if detourDecision == '1':
                        ...
                        print("")
                        print("CONTRAGULATIONS!!! You have completed Space Flight")
                        detourChoice == 'valid'
...
def otherOption():
        ...
        while otherDecision != '1' and otherDecision != '2':
                print("Fire the laser (1) Continue on your way (2)")
                otherDecision = raw_input()

                if otherDecision == '1':
                        print("'Bring the laser online'. Once the laser")
                        print("heats up it fires and scores a direct hit! However,")
                        ...
                        print("uninvited guest, who is incredibly hungry...")
                
        
# Function that will run if player picks asteroid belt
# This is the path that leads to winning the game
def asteroidBelt():
        decision = ''
        ...
        print("The asteroid you were about to mine was huge and if the scanners were to be")
        print("believed,full of raw materials, this was going to be a huge pay off")
        print("")
        ...
        print("dig too fast and you run the risk of losing control of your drill")
        print("and slaming the entire ship into the asteroid")
        print("dig too slow and the steam form the ice could damage the equipment")
        ...
        print("Great, you think to yourself, what do I do now?")
        print("The ship's cargo bay is just over half full,")
...
#function that runs if the play follows the alien ship. Will lead to play death
def followShip():
        followDecision = ''
        ...
        while followdecision != '1' and followDecision != '2':
                print("Stay (1) Continue (2)")
                followDecision = raw_input()
                ...
                elif followDecision =='2':
                        print("'This isn't a Decision I make likely, we don't stop'")
...
#Function that runs if the player desides to ingnore the alien ship, once again, this will always lead to play death
def ignoreShip():
        ignoreDecision = ''
        ...
        while ignoreDecision != '1' and ignoreDecision != '2':
                print(" Fight (1) Flight (2) ")
                ignoreDecision = raw_input()
